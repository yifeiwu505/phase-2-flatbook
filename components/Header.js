    ...
    <div className = "sticky top-0 z-50 bg-white items-center p-2 lg:px-5 shadow-md">
          {/* top left part */}
            ...
            <img 
                ...
                />
                <div 
                className = "flex ml-2 items-center rounded-full bg-grey-100 p-2 flex-shrink">
                    <SearchIcon className = 'h-6'/>
                    
                    <input value ={search} onChange={(e)=>setSearch(e.target.value)} className = "hidden md:inline-flex ml-2 items-center bg-transparent"
                    type="text" placeholder= "Search Flatbook"/>
                </div>
            </div>
